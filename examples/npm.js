...
import { Arg, collect, Command, Flag, Program, RequireAny } from '../src/index';

let initCommand = Command('init', {
...
let installCommand = Command(
  'install',
  {
    ...
    examples: ['npm install jargs --save --save-exact'],
  },
  Arg('lib', {
    multi: true,
  }),
...
let root = collect(
  Program(
    'npm',
    {
      ...
      examples: ['npm run jargs --save --save-exact'],
